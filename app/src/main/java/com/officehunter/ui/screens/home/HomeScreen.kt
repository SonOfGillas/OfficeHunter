package com.officehunter.ui.screens.home
    ...
    Scaffold(
        floatingActionButton = {
            FloatingActionButton(
                ...
                onClick = { navController.navigate(OfficeHunterRoute.AddTravel.route) }
            ) {
            ...
            LazyVerticalGrid(
                ...
                items(state.places) { item ->
                    TravelItem(
                        item,
                        onClick = {
                            navController.navigate(OfficeHunterRoute.TravelDetails.buildRoute(item.id.toString()))
                        }
                    )
                }
            }
